        ...
        <div class="col-lg-10 p-3">
            <div class="card">
                ...
                <div class="card-body p-3">
                    <form method="POST" action="{{ route('admin.workshop.baby.article.update', ['record' => $record->id]) }}"
                    ...
                    <div class="form-group row mb-0 mt-5">
                        <div class="col-md-6 offset-md-5 text-center text-md-left">
                            <form action="{{ route('admin.workshop.baby.article.delete', ['record' => $record->id]) }}" method="POST">
                                @csrf
