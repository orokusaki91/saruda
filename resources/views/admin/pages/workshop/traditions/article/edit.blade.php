        ...
        <div class="col-lg-10 p-3">
            <div class="card">
                ...
                <div class="card-body p-3">
                    <form method="POST" action="{{ route('admin.workshop.traditions.article.update', ['record' => $record->id]) }}"
                        ...
                        <div class="row pb-md-3 align-items-center">
                            ...
                            <div class="col-md-4 pb-3 pb-md-0">
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" required>{{ $record->description }}</textarea>
                    ...
                    <div class="form-group row mb-0 mt-5">
                        <div class="col-md-6 offset-md-5 text-center text-md-left">
                            <form action="{{ route('admin.workshop.traditions.article.delete', ['record' => $record->id]) }}" method="POST">
                                @csrf
