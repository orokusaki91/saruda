...
<div class="container-fluid p-3">
    ...
    <hr />
    <a href="{{ route('admin.workshop.prehistory.create') }}" class="btn btn-create">
        Create New Record
    </a>
    <hr />
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered nowrap">
            ...
            <tbody>
                @include('admin.pages.workshop.prehistory._list')
            </tbody>
        </table>
    </div>
    <hr>
    <div class="container">
        ...
        <div class="card">
            <div class="card-body p-3">
                <form method="POST" action="{{ route('admin.workshop.prehistory.pdf.store') }}" enctype="multipart/form-data">
                    @csrf
